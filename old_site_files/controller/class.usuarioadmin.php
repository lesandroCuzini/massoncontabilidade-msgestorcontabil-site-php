...
class UsuarioAdmin extends UsuarioAdminModel {
    ...
    public function postProcess($acao) {
        ...
        elseif ($acao == "alterar_senha") {
            ...
            if ($this->alterarSenha($id)) {
                $acao_posterior = getRequest('acao_posterior');
                if ($acao_posterior == "new") {
                    header("Location: " . BASE_ADMIN_URL . '/senha-form.html'."?msg=ok");
                } else {
                    header("Location: " . BASE_ADMIN_URL . '/senha-form.html'."?msg=ok&id=" . $id);
                }
            } else {
                header("Location: " . BASE_ADMIN_URL . '/senha-form.html'."?msg=erro&id=" . $id);
            }
            die;
        }
    ...
    public function insert() {
        ...
        $this->setUltimoAcesso('0000-00-00 00:00:00');
        ...
        $this->setDatahoraCiente('0000-00-00 00:00:00');
        $id = $this->incluir();
        $this->setIdTable($id);
