...
class PerguntaFrequente extends PerguntaFrequenteModel {
    
    private $pagina_retorno = 'perguntas_frequentes-form.html';
    ...
    */
    public function insert() {
        ...
        if(getRequest("pergunta_frequente") == "" || getRequest("resposta_pergunta_frequente") == ""){
            return false;
        }
        $this->setPerguntaFrequente(getRequest("pergunta_frequente"));
        $this->setRespostaPerguntaFrequente(getRequest("resposta_pergunta_frequente"));
