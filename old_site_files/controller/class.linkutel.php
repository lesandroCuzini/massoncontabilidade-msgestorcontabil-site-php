...
class LinkUtel extends LinkUtelModel {
    
    private $pagina_retorno = 'links_uteis-form.html';
    ...
    */
    public function insert() {
        ...
        $this->setNomeLinkUtel(getRequest("nome_link_utel"));
        $linkUtel = $_POST['link_utel'];
        if (substr($linkUtel, 0, 4) != "http" && $linkUtel != "#" && $linkUtel != "") {
            $linkUtel = "http://" . $linkUtel;
        }
        $this->setLinkUtel($linkUtel);
        $this->setIdTipoLinkUtel(getRequest("id_tipo_link_utel"));
     ...
     * @return array
     */
    public function getLinksUteisByTipoLinkUtel($id_tipo_link_utel)
    {
        return parent::getLinksUteisByTipoLinkUtel($id_tipo_link_utel);
    }
}
