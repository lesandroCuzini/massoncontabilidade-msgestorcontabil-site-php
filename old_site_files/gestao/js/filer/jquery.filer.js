                    ...
                    _thumbCreator: {
                        ...
                        renderFile: function(file, html, opts) {
                            ...
                            if (file.file && opts.type == "image") {
                                ...
                                if(file.capa) {
                                    m.closest('.jFiler-item-container').addClass('capa').attr('data-id-image',file.id_image);
                                }else{
                                    m.closest('.jFiler-item-container').addClass('no-capa').attr('data-id-image',file.id_image);
                                }
