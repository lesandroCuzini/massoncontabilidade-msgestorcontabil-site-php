...
class MinifyFile {
    ...
    public function render ( $return = false ) {
        ...
        $header  = '/** '.PHP_EOL;
        $header .= " * 3dots ".PHP_EOL;
        $header .= ' * File private - not use'.PHP_EOL;
        $header .= ' * https://www.3dots.com.br'.PHP_EOL;
        $header .= ' * @author 3dots (contat@3dots.com.br)'.PHP_EOL;
    ...
    private function run () {
        ...
        if (count($this->_files) === 0) {
            trigger_error('3dots Minify: There\'s no files to be minified!', E_WARNING);
            exit;
        }
    ...
    private function do_uglify ( $raw_code ) {
        if (!function_exists('curl_init')) {
            trigger_error('3dots Minify: Impossible to uglify your code, this PHP instance does not have CURL.');
            return $raw_code;
        }
