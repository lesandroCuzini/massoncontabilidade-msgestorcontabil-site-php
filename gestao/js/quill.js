    ...
    return /******/ (function (modules) { // webpackBootstrap
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            function _sanitize(url, protocols) {
                ...
                link.href = url;
                var protocol = link.href.slice(0, link.href.indexOf(':'));
            ...
            Toolbar.DEFAULTS = {
                ...
                handlers: {
                    ...
                    anchor: function anchor(value) {
                        ...
                        this.quill.format('anchor', value, _quill2.default.sources.USER);
                    },
                        ...
                        switch (this.root.getAttribute('data-mode')) {
                            ...
                            case 'anchor':
                            {
                                ...
                                if (this.linkRange) {
                                    ...
                                    this.restoreFocus();
                                    this.quill.format('anchor', value, _emitter2.default.sources.USER);
                                }
                                this.quill.root.scrollTop = scrollTop;
                                break;
                            }
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            var Anchor = function (_Inline) {
                console.log('5');
                _inherits(Anchor, _Inline);
                ...
                _createClass(Anchor, [{
                    ...
                    value: function format(name, value) {
                        console.log('5');
                        if (name !== this.statics.blotName || !value) return _get(Anchor.prototype.__proto__ || Object.getPrototypeOf(Anchor.prototype), 'format', this).call(this, name, value);
                        value = this.constructor.sanitize(value);
                        this.domNode.setAttribute('name', value);
                    }
                }], [{
                    ...
                    value: function create(value) {
                        console.log('1');
                        var node = _get(Anchor.__proto__ || Object.getPrototypeOf(Anchor), 'create', this).call(this, value);
                        value = this.sanitize(value);
            ...
            Anchor.tagName = 'A';
            Anchor.SANITIZED_URL = 'about:blank';
