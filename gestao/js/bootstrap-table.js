...
!function ($) {
    ...
    BootstrapTable.DEFAULTS = {
        ...
        formatLoadingMessage: function () {
            return 'Atualizando, por favor aguarde…';
        },
        formatRecordsPerPage: function (pageNumber) {
            return sprintf('%s registros por página', pageNumber);
        },
        formatShowingRows: function (pageFrom, pageTo, totalRows) {
            return sprintf('Mostrando %s de %s ', pageFrom, totalRows);
        },
            ...
            $.each(this.header.fields, function (j, field) {
                ...
                if (that.options.columns[j].checkbox || that.options.columns[j].radio) {
                    ...
                    text = that.options.cardView ?
                        ['<div class="card-view">',
                            that.options.showHeader ? sprintf('<span class="title" %s><strong>%s:</strong> </span>', style,
