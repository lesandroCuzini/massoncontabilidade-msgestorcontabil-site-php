...
class ImagemTool {
   ...
   * Construtor
   * @param string $origem
   * @param array $extensoes_validas
   * @internal param \caminho $string da imagem a ser carregada
   * @return void
   */
  public function ImagemTool( $origem = '', $extensoes_validas = array( 'jpg', 'jpeg', 'jpe', 'gif', 'bmp', 'png' ) )
  {
   ...
   * @param string $origem
   * @internal param \String \caminho $da imagem a ser carregada
   * @return void
   */
...
// funções para redimensionamento
   ...
   * @param $g
   * @param $b
   * @internal param \R $Valores , G e B
   * @return Void
   */
   ...
   * @param $x
   * @param $y
   * @internal param \valores $Array x e y
   * @return Void
   */
  ...
  private function resizeFill()
  {
    if ($this->extensao == "png") {
      ...
      //Preenche a Cor de Fundo da Imagem
