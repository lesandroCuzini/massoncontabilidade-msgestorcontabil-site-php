...
class Model
{
    ...
    public function __construct($submit = false, $con = 1)
    {
        ...
        elseif ($submit && $_SERVER['REQUEST_METHOD'] == 'DELETE') {
            ...
            // usuario 3dots não será apagado, assim como o Perfil SuperAdmin
    ...
    /**
     * Busca Imagem deletada
     * @author 3dots
     * @param $tables
     * @param $aliases
     * @return array
     */
    protected function buscaImagemNula($campo_regitro,$id,$campo){
        $sql = "SELECT ".$campo." FROM ".$this->getTable()." WHERE ".$campo_regitro." = ".$id;
     ...
     * @return array
     */
    protected function buscaUrl($url)
    {
        $query = "SELECT * FROM ".$this->table." WHERE url_amigavel = '".$url."'";
